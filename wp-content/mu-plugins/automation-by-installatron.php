<?php
/*
  Plugin Name: WordPress automation by Aplikacje zenbox.pl
  Description: Management of this WordPress site is provided by Aplikacje zenbox.pl.
*/

// This plugin was added because Automatic Updates, Automatic Backups, and
// other features are managed externally by Aplikacje zenbox.pl.
...
// advised to disable auto-updating in Aplikacje zenbox.pl.
add_filter( 'automatic_updater_disabled', '__return_true' );

// Disable WordPress site health test for Automatic Updates since these are
// managed externally by Aplikacje zenbox.pl.
