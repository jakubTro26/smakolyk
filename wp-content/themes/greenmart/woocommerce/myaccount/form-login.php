...
<?php endif; ?>
		...
		<form method="post" class="woocommerce-form woocommerce-form-login login" role="form">
			...
			<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Login', 'greenmart' ); ?>"><?php esc_html_e( 'Login', 'greenmart' ); ?></button>
	...
	<div class="col-md-6 col-12">
		...
		<form method="post" class="register widget" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<p class="form-group form-row">
				...
				<button type="submit" class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit" name="register" value="<?php esc_attr_e( 'Register', 'greenmart' ); ?>"><?php esc_html_e( 'Register', 'greenmart' ); ?></button>
			</p>
