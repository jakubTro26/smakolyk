...
<?php if ( wc_coupons_enabled() ) { ?>
		<div class="coupon ">
			...
			<input type="text" name="coupon_code" class="input-text " id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Enter coupon code here...', 'greenmart' ); ?>" /> <input type="submit" class="btn btn-default" name="apply_coupon" value="<?php esc_attr_e( 'Apply', 'greenmart' ); ?>" />
