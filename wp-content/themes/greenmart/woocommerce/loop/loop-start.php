...
$screen_landscape = ($skin === 'organic-el' || $skin === 'fresh-el') ? 2 : '';
...
$data_elemntor = ($skin === 'organic-el' || $skin === 'fresh-el') ? ' data-landscape='. $screen_landscape .'' : '';

$data_responsive .= $data_elemntor;
