...
$isfullwidth = (isset($isfullwidth)) ? $isfullwidth : false;
...
global $tbaymegamenu, $footer_builder;
if ( $footer_builder ) {
...
$output .='<div class="'.apply_filters('greenmart_tbay_class_container_vc', 'container', $isfullwidth, $post_type).'">';
