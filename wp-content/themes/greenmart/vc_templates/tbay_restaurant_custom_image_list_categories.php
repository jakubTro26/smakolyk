...
$class_to_filter = 'widget widget-custom-categories '. $style. '';
    ...
    <?php if ( isset($categoriestabs) && $categoriestabs ) : ?>
        <div class="widget-content woocommerce">
            ...
            <div class="row" <?php echo esc_attr($data_responsive); ?>>
                <?php  wc_get_template( 'layout-categories/'.  $active_theme .'/'. 'custom.php' , array( 'categoriestabs' => $categoriestabs, 'columns' => $columns , 'screen_desktop' => $screen_desktop, 'screen_desktopsmall' => $screen_desktopsmall, 'screen_tablet' => $screen_tablet, 'screen_mobile' => $screen_mobile ) ); ?>
            </div>
        </div>
    <?php endif; ?>
