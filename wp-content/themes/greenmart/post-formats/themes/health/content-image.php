	...
	<?php
	  ...
	  <div class="row">
	    ...
	    <div class="entry-content col-md-7 <?php echo ( !has_post_thumbnail() ) ? 'no-thumb' : ''; ?>">
			...
			<div class="entry-description"><?php echo greenmart_tbay_substring( get_the_content(), 30, '[...]' ); ?></div>
			<a href="<?php the_permalink(); ?>" class="readmore" title="<?php esc_attr_e( 'Read More', 'greenmart' ); ?>"><?php esc_html_e( 'Read more', 'greenmart' ); ?></a>
	    </div>
	</div>
    <?php endif; ?>
    <?php if ( is_single() ) : ?>
