...
if( $show_text_account !== 'yes' ) $this->add_render_attribute('wrapper', 'class', 'no-text-account');

$url_login = apply_filters('greenmart_woocommerce_my_account_url', get_permalink(wc_get_page_id('myaccount') ) );
?>
