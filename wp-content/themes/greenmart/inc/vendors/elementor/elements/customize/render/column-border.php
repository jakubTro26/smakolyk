...
if ( !function_exists('greenmart_render_element_child_border')) {
    function greenmart_render_element_child_border( $widget ) {
    ...
    add_action('elementor/frontend/column/before_render', 'greenmart_render_element_child_border', 10, 2 );
}
