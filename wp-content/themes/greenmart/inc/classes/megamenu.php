        ...
        public function generateSubMegaMenu( $item, $tbay_mega_profile ) {
            ...
            if ( $tbay_mega_profile ) {
                ...
                if ( $posts && isset($posts[0]) ) {
                    ...
                    if( greenmart_elementor_is_activated() && Elementor\Plugin::instance()->documents->get( $post->ID )->is_built_with_elementor() ) {
                        $content = Elementor\Plugin::instance()->frontend->get_builder_content_for_display( $post->ID, greenmart_get_elementor_css_print_method() );
                    } else { 
                    ...
                    if( greenmart_tbay_get_config('ajax_dropdown_megamenu', false) ) {  
