...
class Tbay_Widget_Single_Image extends Tbay_Widget {
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <textarea class="widefat" id="<?php echo esc_attr($this->get_field_id( 'description' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'description' )); ?>" rows="3" cols="30"><?php echo esc_html($instance['description']); ?></textarea>
        </p>
