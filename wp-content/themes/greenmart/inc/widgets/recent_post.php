...
class Tbay_Widget_Recent_Post extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'tbay_recent_post',
            esc_html__('Tbay Recent Posts Widget', 'greenmart'),
            array( 'description' => esc_html__( 'Show list of recent post', 'greenmart' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>">
                <?php echo esc_html__('Type:', 'greenmart' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'greenmart' ); ?></label>
