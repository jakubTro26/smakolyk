...
class Tbay_Widget_Featured_Video_Widget extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'tbay_featured_video_widget',
            // Widget name will appear in UI
            esc_html__('Tbay Featured Video Widget', 'greenmart'),
             // Widget description
            array( 'description' => esc_html__( 'Show Featured video', 'greenmart' ),)
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo  esc_attr($this->get_field_id( 'video_link' )); ?>"><?php echo esc_html__('Video link:', 'greenmart' ); ?></label>
            <br>
            ...
            <br>
            <?php echo esc_html__('Support video from Youtube and Vimeo link. Ex: https://www.youtube.com/watch?v=sd0grLQ4voU', 'greenmart' ); ?>
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_name') ); ?>"><?php echo esc_html__('Video name:', 'greenmart' ); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_width')); ?>"><?php echo esc_html__('Video width:', 'greenmart'); ?></label>
            <br>
