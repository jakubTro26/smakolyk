...
/*TopBar Color*/
$output['topbar_bg'] = array('#tbay-topbar, #tbay-header.header-v2 #tbay-topbar, #tbay-header.header-v4 #tbay-topbar');
$output['topbar_text_color'] = array(
    'color' => greenmart_texttrim('#tbay-topbar, #tbay-header.header-v2 #tbay-topbar, #tbay-header.header-v4 #tbay-topbar')
);
$output['topbar_link_color'] = array(
    'color' => greenmart_texttrim('#tbay-topbar a, #tbay-header.header-v2 #tbay-topbar a, #tbay-header.header-v4 #tbay-topbar a')
);
...
$output['header_link_color'] = array(
    'color' => greenmart_texttrim('#tbay-header a, #tbay-header.header-v3 .header-main a,.list-inline.acount li a.login,#tbay-header.header-v4 .header-main .tbay-mainmenu .btn-offcanvas,#tbay-header.header-v6 .header-inner .right-item .list-inline.acount li a,
...
$output['footer_text_color'] = array(
    'color' => greenmart_texttrim('#tbay-footer, #tbay-footer .widget .description, .bottom-footer')
);
