...
function greenmart_tbay_customize_register( $wp_customize ) {
	...
	if( class_exists( 'VI_Woo_Photo_Reviews' ) ) {
		...
		$wp_customize->add_setting(
			'greenmart_photo_reviews_thumbnail_image_width',
			array(
				'default'              => 70,
				'type'                 => 'option',
				'capability'           => 'manage_woocommerce',
		...
		$wp_customize->add_control(
			'greenmart_photo_reviews_thumbnail_image_width',
			array(
				'label'       => esc_html__( 'Photo Reviews thumbnail image width', 'greenmart' ),
				'description' => esc_html__( 'Image size used for the comment photo review.', 'greenmart' ),
				'section'     => 'woocommerce_product_images',
				'settings'    => 'greenmart_photo_reviews_thumbnail_image_width',
				'type'        => 'number',
				'input_attrs' => array(
					'min'  => 0,
					'step' => 1,
		...
		$wp_customize->add_setting(
			'greenmart_photo_reviews_thumbnail_image_height',
			array(
				'default'              => 105,
				'type'                 => 'option',
				'capability'           => 'manage_woocommerce',
		...
		$wp_customize->add_control(
			'greenmart_photo_reviews_thumbnail_image_height',
			array(
				'label'       => esc_html__( 'Photo Reviews thumbnail image height', 'greenmart' ),
				'description' => esc_html__( 'Image size used for the comment photo review.', 'greenmart' ),
				'section'     => 'woocommerce_product_images',
				'settings'    => 'greenmart_photo_reviews_thumbnail_image_height',
				'type'        => 'number',
				'input_attrs' => array(
					'min'  => 0,
					'step' => 1,
		...
		$wp_customize->add_setting(
			'greenmart_photo_reviews_thumbnail_image_cropping',
			array(
				'default'              => 'yes',
				'type'                 => 'option',
				'capability'           => 'manage_woocommerce',
		...
		$wp_customize->add_control(
			'greenmart_photo_reviews_thumbnail_image_cropping',
			array(
				'label'    => esc_html__( 'Enable cropped photo reviews thumbnail', 'greenmart' ),
				'description' => esc_html__( 'Images will be cropped to a custom size above.', 'greenmart' ),
				'section'  => 'woocommerce_product_images',
				'settings' => 'greenmart_photo_reviews_thumbnail_image_cropping',
				'type'     => 'checkbox',
			)
		);
