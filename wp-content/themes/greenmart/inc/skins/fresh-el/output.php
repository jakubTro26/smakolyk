...
$output['header_mobile_color'] = array( 
	'color' => greenmart_texttrim('.topbar-device-mobile i, .topbar-post > .topbar-title,
	 .topbar-device-mobile.active-home-icon .topbar-title, .topbar-device-mobile .search-device i')
);
